...
$TempDirectory = "C:\Temp\[Enter folder name here]"
$PowerShellVersion = $PSVersionTable.PSVersion
#---Varilables [App Specific]
$App = ""
$DownloadApp = "enter URL here"
$Installer = "enter file name here"
$TempFilePath = Join-Path -Path $TempDirectory -ChildPath $Installer
$Arg = "define parameters heres"
