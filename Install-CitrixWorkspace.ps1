...
#####Create temporary directory to download and install application(s) from
...
#####Checks if .NET 4.8 or greater is installed, if not, downloads and installs .NET 4.8
...
#####Removes temporary directory and all files within
